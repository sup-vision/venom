from mongoengine import (
    Document, StringField, ObjectIdField, EnumField,
...
class Attendance(Document):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'student_image_id': str(self.student_image_id) if self.student_image_id else None,
            'class_image_id': str(self.class_image_id) if self.class_image_id else None,
